...
_ {{ site.app_name_foucspad_cn }}_ 是一款由 _ {{ site.company_name_cn}}_ （以下简称”我们“）提供的产品。 您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。 本《隐私政策》与您所使用的 _ {{ site.app_name_foucspad_cn }}_ 服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。
...
*   **个人信息**，您使用我们的应用时，需要你的授权使应用能够获取用户设备上的已安装程序列表，用户可以从中选择希望屏蔽的应用来避免分散注意力，以改善专注体验。
